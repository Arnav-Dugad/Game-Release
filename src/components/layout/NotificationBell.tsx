          ...
          >
            ...
            {!user ? (
              <div className="flex flex-col items-center px-6 py-9 text-center">
                ...
                <h3 className="mt-4 font-display text-sm font-bold">Your releases and deals, together</h3>
                <p className="mt-2 max-w-xs text-xs leading-relaxed text-muted">Sign in to get watchlist release reminders and regional discount alerts.</p>
              ...
              <div className="px-6 py-10 text-center">
                ...
                <p className="mt-1.5 text-xs leading-relaxed text-muted">Track upcoming games and alerts will appear as launch approaches or prices drop.</p>
              </div>
            ) : (
