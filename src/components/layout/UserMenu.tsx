...
import { BarChart3, Bell, Bookmark, Library, LogOut, Settings, User as UserIcon } from "lucide-react";
      ...
      <AnimatePresence>
        {open && (
          ...
          >
            ...
            <MenuLink href="/stats" icon={<BarChart3 size={15} />} onClick={() => setOpen(false)}>
              Personal stats
            </MenuLink>
